...
export default function TopBar({
    ...
    const paddingIfOpen = isOpen ? "pl-[250px]" : "pl-0 sm:pl-[80px]";
        ...
        >
            ...
            <div className="w-full h-[60px] flex">
                ...
                <div className="w-full h-full px-[16px] py-[14px] flex justify-between items-center gap-1 sm:gap-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
                    ...
                    <div className={`flex items-center gap-[10px] ${isOpen ? "opacity-0 sm:opacity-100 transition-all duration-300 ease-in-out" : ""}`}>
                        <IconButton
