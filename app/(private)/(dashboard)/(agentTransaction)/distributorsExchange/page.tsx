...
import { exchangeList, exportExchangeData,exchangeGlobalFilter } from "@/app/services/agentTransaction";
...
useEffect(() => {
          ...
          const filterBy = useCallback(
              async (
                  ...
                  try {
                      ...
                      result = await exchangeGlobalFilter(body);
                  } finally {
                      setLoading(false);
                      // setColFilter(false);
                  }
    ...
    const exportFile = async (format: 'csv' | 'xlsx' = 'csv') => {
        try {
            ...
            const response = await exportExchangeData({ format,filter:filterPayload });
