...
export default function AddEditVehicleWithStepper() {
  ...
  const { warehouseOptions, warehouseAllOptions,ensureWarehouseAllLoaded,ensureWarehouseLoaded } = useAllDropdownListData();
  ...
  }, [ensureWarehouseLoaded, ensureWarehouseAllLoaded, isEditMode]);
              ...
              {form.ownerType !== "company" && (
                <div>
                  <InputFields
                    ...
                    onChange={handleChange}
                    name="warehouseId"
                    options={isEditMode ? warehouseOptions : warehouseAllOptions}
