              ...
              {!isNestedDropdownValue ? <>
                ...
                {visibleLabels.includes("region") && (
                  <InputFields
                    ...
                    name="region"
                    isSingle={false}
                    disabled={options.region.length === 0 || !values.company || values.company.length === 0}
                    searchable={true}
                    multiSelectChips={true}
                    value={values.region}
                ...
                {visibleLabels.includes("area") && (
                  <InputFields
                    ...
                    isSingle={false}
                    searchable={true}
                    disabled={options.area.length === 0 || !values.region || values.region.length === 0}
                    multiSelectChips={true}
                    value={values.area}
                ...
                {visibleLabels.includes("warehouse") && (
                  <InputFields
                    ...
                    isSingle={false}
                    searchable={true}
                    disabled={options.warehouse.length === 0 || !values.area || values.area.length === 0}
                    multiSelectChips={true}
                ...
                {visibleLabels.includes("route") && (
                  <InputFields
                    ...
                    isSingle={false}
                    searchable={true}
                    disabled={options.route.length === 0 || !values.warehouse || values.warehouse.length === 0}
                    multiSelectChips={true}
                    value={values.route}
                    ...
                    onChange={async (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
                      ...
                      try {
                        ...
                        const options = regions.data.map((region: { id: string; category_code: string; category_name: string }) => ({ value: String(region.id), label: (region.category_name || "") })) ?? [];
                ...
                {visibleLabels.includes("item category") && (() => {
                  return (
                    <InputFields
                      ...
                      isSingle={false}
                      searchable={true}
                      disabled={options.itemCategory.length === 0 || !values.route}
                      multiSelectChips={true}
                ...
                {visibleLabels.includes("item") && (() => {
                  return (
                    <InputFields
                      ...
                      isSingle={false}
                      searchable={true}
                      disabled={options.item.length === 0 || !values.itemCategory || values.itemCategory.length === 0}
                      multiSelectChips={true}
                      value={values.item || []}
                      ...
                      onChange={async (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
                        ...
                        try {
                          ...
                          const options = items.data.map((item: { id: string; outlet_channel: string; outlet_channel_code: string }) => ({ value: String(item.id), label:(item.outlet_channel || "") })) ?? [];
                ...
                {visibleLabels.includes("customer channel") && (() => {
                  return (
                    <InputFields
                      required
                      searchable={true}
                      disabled={options.customerChannel.length === 0 || !values.item}
                      ...
                      onChange={async (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
                        ...
                        try {
                          ...
                          const options = customerCategories.data.map((customerCategory: { id: string; customer_category_code: string; customer_category_name: string }) => ({ value: String(customerCategory.id), label: (customerCategory.customer_category_name || "") })) ?? [];
                ...
                {visibleLabels.includes("customer category") && (() => {
                  return (
                    <InputFields
                      required
                      searchable={true}
                      disabled={options.customerCategory.length === 0 || !values.customerChannel || values.customerChannel.length === 0}
                      ...
                      onChange={async (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
                        ...
                        try {
                          ...
                          const options = itemSubCategories.data.map((itemSubCategory: { id: string; customer_sub_category_code: string; customer_sub_category_name: string }) => ({ value: String(itemSubCategory.id), label: (itemSubCategory.customer_sub_category_name || "") })) ?? [];
                ...
                {visibleLabels.includes("customer sub category") && (() => {
                  return (
                    <InputFields
                      ...
                      searchable={true}
                      disabled={options.customerSubCategory.length === 0 || !values.customerCategory || values.customerCategory.length === 0}
                      isSingle={false}
                      multiSelectChips={true}
                ...
                {visibleLabels.includes("customer") && (() => {
                  return (
                    <InputFields
                      required
                      searchable={true}
                      disabled={options.customer.length === 0 || !values.customerSubCategory || values.customerSubCategory.length === 0}
                      label="Customer"
                      name="customer"
                      isSingle={false}
                      multiSelectChips={true}
