...
export const purchaseOrderExportHeader = async (body?: Object) => {
  try {
    // available params - from_date, to_date, format
    const res = await API.post(`/api/hariss_transaction/ht_orders/exportheader`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const orderExportHeader = async (body?: Object) => {
  try {
    // available params - from_date, to_date, format
    const res = await API.post(`/api/hariss_transaction/ht_orders/exportheader`, body);
    return res.data;
...
export const invoiceExportHeader = async (body?: Object) => {
  try {
    // available params - from_date, to_date, format
    const res = await API.post(`/api/hariss_transaction/ht_invoice/exportheader`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const deliveryExportHeader = async (body?: Object) => {
  try {
    // available params - from_date, to_date, format
    const res = await API.post(`/api/hariss_transaction/ht_delivery/exportheader`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const returnExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/hariss_transaction/ht_returns/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
