...
export const exportSalesmanLoad = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/load/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportNewCustomer = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/new-customer/export`, { params: body });
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportCapsCollection = async (body: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/capscollection/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportInvoice = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/invoices/exportHeader`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportReturnInvoice = async (params?: Params) => {
  try {
    const res = await API.get(`/api/master/items/item-returns`, { params });
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const agentDeliveryExport = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/agent-delivery/exportall`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const agentOrderExport = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/orders/exportall`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const agentReturnExport = async (body: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/returns/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportExchangeData = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/exchanges/export`, body);
    return res.data;
  } catch (error: unknown) {
...
export const advancePaymentExport = async (body: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/advancepayments/export`, { params: body });
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const capsExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/capscollection/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const loadExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/load/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const orderExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/orders/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const invoiceExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/invoices/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const returnExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/returns/exportcollapse
`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
...
export const unloadExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/unload/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const deliveryExportCollapse = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/agent-delivery/exportcollapse`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const agentOrderHeaderExport = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/orders/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const agentDeliveryHeaderExport = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/agent-delivery/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const capsGlobalFilter = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/capscollection/globalFilter`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exchangeGlobalFilter = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/exchanges/globalFilter`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const returnHeader = async (body?: Object) => {
  try {
    const res = await API.post(`/api/agent_transaction/returns/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const getInvoices = async (params?: Params) => {
  try {
    const res = await API.get(`/api/agent_transaction/returns/getInoviceBasedReturn`, {params});
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
