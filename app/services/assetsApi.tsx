...
export const irReportByUUID = async (uuid: string, params?: Params) => {
  try {
    const res = await API.get(`/api/assets/ir/${uuid}`, {
      params: params,
    });
    return res.data;
  } catch (error: unknown) {
...
export const serviceVisitExport = async (body?: Object) => {
  try {
    const res = await API.post(`/api/assets/service-visit/export`, body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
...
export const exportCallRegister = async (body: Object) => {
  try {
    const res = await API.post("/api/assets/call-register/export", body);
    return res.data;
  } catch (error: unknown) {
    return handleError(error);
  }
