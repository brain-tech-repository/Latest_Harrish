...
export default function StepperForm({
  ...
  const getStepStyles = (status: string, stepNumber: number) => {
    switch (status) {
      ...
      default:
        return {
          circle: "text-[#8F9BB3]", // uses inline style for bg
          circleBg: "var(--stepper-pending-bg, #E4E9F2)",
          label: "font-medium",
          labelColor: "var(--stepper-pending-text, #8F9BB3)",
          icon: null
        };
    }
  };
              ...
              <div className="flex flex-col items-center">
                <div
                  ...
                  style={{ 
                    ...
                    zIndex: 1,
                    ...(status === 'pending' && styles.circleBg ? { backgroundColor: styles.circleBg, borderColor: styles.circleBg } : {})
                  }}
                ...
                <span 
                  className={`mt-2 text-[10px] sm:text-xs text-center max-w-24 leading-tight ${styles.label}`}
