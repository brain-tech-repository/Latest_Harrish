          ...
          return (
            <div className="w-full relative">
              <input
                ...
                type="text"
                value={value ?? ""}
                onChange={disabled ? undefined : safeOnChange}
                disabled={disabled}
                readOnly={disabled}
                onKeyDown={disabled ? (e) => e.preventDefault() : undefined}
                onPaste={disabled ? (e) => e.preventDefault() : undefined}
                onDrop={disabled ? (e) => e.preventDefault() : undefined}
                onBlur={onBlur}
                autoComplete="off"
          ...
          return isSingle === false ? (
            <div className="relative select-none w-full" ref={dropdownRef}>
              <div
                ...
                onMouseDown={disabled ? (e) => e.preventDefault() : () => { pointerDownRef.current = true; }}
                onMouseUp={disabled ? (e) => e.preventDefault() : () => { pointerDownRef.current = false; }}
                onFocus={disabled ? (e) => e.preventDefault() : () => {
                ...
                onKeyDown={disabled ? (e) => e.preventDefault() : (!isSearchable ? createArrowKeyHandler(
                  filteredOptions,
                  highlightedIndex,
                  setHighlightedIndex,
